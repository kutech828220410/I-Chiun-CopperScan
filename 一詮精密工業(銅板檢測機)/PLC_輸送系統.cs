...
namespace 一詮精密工業_銅板檢測機_
{
    public partial class Main_Form : MyDialog
    {
        ...
        PLC_Device PLC_Device_輸送系統_輸送帶入料區有盤 = new PLC_Device("X50");
        PLC_Device PLC_Device_輸送系統_輸送帶CCD區有盤 = new PLC_Device("X51");
        PLC_Device PLC_Device_輸送系統_輸送帶不良排除區有盤 = new PLC_Device("X52");
        PLC_Device PLC_Device_輸送系統_輸送帶出料區有盤 = new PLC_Device("X53");

        PLC_Device PLC_Device_輸送系統_輸送帶入料區無盤 = new PLC_Device();
        PLC_Device PLC_Device_輸送系統_輸送帶CCD區無盤 = new PLC_Device();
        PLC_Device PLC_Device_輸送系統_輸送帶不良排除區無盤 = new PLC_Device();
        PLC_Device PLC_Device_輸送系統_輸送帶出料區無盤 = new PLC_Device();
        ...
        void sub_Program_輸送系統_輸送一格()
        {
            ...
            PLC_Device_輸送系統_輸送帶出料區無盤.Bool = !PLC_Device_輸送系統_輸送帶出料區有盤.Bool;


            if (PLC_Device_輸送系統_輸送帶入料區有盤.Bool)
            {
                if(MyTimer_輸送系統_輸送帶入料區有盤延遲.IsTimeOut())
                {
                    flag_輸送系統_輸送帶入料區有盤 = true;
                }
            }
            else
            {
                MyTimer_輸送系統_輸送帶入料區有盤延遲.TickStop();
                MyTimer_輸送系統_輸送帶入料區有盤延遲.StartTickTime(PLC_Device_輸送系統_輸送帶有盤延遲.Value);
                flag_輸送系統_輸送帶入料區有盤 = false;
            }
            ...
            if (PLC_Device_輸送系統_輸送帶出料區有盤.Bool)
            {
                if (MyTimer_輸送系統_輸送帶出料區有盤延遲.IsTimeOut())
                {
                    flag_輸送系統_輸送帶出料區有盤 = true;
                }
            }
            else
            {
                MyTimer_輸送系統_輸送帶出料區有盤延遲.TickStop();
                MyTimer_輸送系統_輸送帶出料區有盤延遲.StartTickTime(PLC_Device_輸送系統_輸送帶有盤延遲.Value);
                flag_輸送系統_輸送帶出料區有盤 = false;
            }

            if (PLC_Device_輸送系統_輸送帶入料區無盤.Bool)
            {
                if (MyTimer_輸送系統_輸送帶入料區無盤延遲.IsTimeOut())
                {
                    flag_輸送系統_輸送帶入料區無盤 = true;
                }
            }
            else
            {
                MyTimer_輸送系統_輸送帶入料區無盤延遲.TickStop();
                MyTimer_輸送系統_輸送帶入料區無盤延遲.StartTickTime(PLC_Device_輸送系統_輸送帶無盤延遲.Value);
                flag_輸送系統_輸送帶入料區無盤 = false;
            }
            ...
            if (PLC_Device_輸送系統_輸送帶出料區無盤.Bool)
            {
                if (MyTimer_輸送系統_輸送帶出料區無盤延遲.IsTimeOut())
                {
                    flag_輸送系統_輸送帶出料區無盤 = true;
                }
            }
            else
            {
                MyTimer_輸送系統_輸送帶出料區無盤延遲.TickStop();
                MyTimer_輸送系統_輸送帶出料區無盤延遲.StartTickTime(PLC_Device_輸送系統_輸送帶無盤延遲.Value);
                flag_輸送系統_輸送帶出料區無盤 = false;
            }
            ...
            if (cnt_Program_輸送系統_輸送一格 == 102) cnt_Program_輸送系統_輸送一格 = 65500;
            ...
            if (cnt_Program_輸送系統_輸送一格 == 202) cnt_Program_輸送系統_輸送一格 = 65500;

            if (cnt_Program_輸送系統_輸送一格 == 300) cnt_Program_輸送系統_輸送一格_300_等待出料區盤感應離開(ref cnt_Program_輸送系統_輸送一格);
            if (cnt_Program_輸送系統_輸送一格 == 301) cnt_Program_輸送系統_輸送一格_300_等待出料區盤感應到達(ref cnt_Program_輸送系統_輸送一格);
            if (cnt_Program_輸送系統_輸送一格 == 302) cnt_Program_輸送系統_輸送一格 = 65500;

            if (cnt_Program_輸送系統_輸送一格 == 400) cnt_Program_輸送系統_輸送一格_400_計時輸出(ref cnt_Program_輸送系統_輸送一格);
            if (cnt_Program_輸送系統_輸送一格 == 401) cnt_Program_輸送系統_輸送一格 = 65500;
        ...
        void cnt_Program_輸送系統_輸送一格_初始化(ref int cnt)
        {
            ...
            if (flag_輸送系統_輸送帶入料區有盤 == true)
            {
                Console.WriteLine($"[輸送一格] 入料區有盤,等待CCD區盤感應到達");
                PLC_Device_輸送系統_輸送帶解煞車.Bool = true;
                PLC_Device_輸送系統_輸送帶正轉.Bool = true;
                cnt = 100;
                return;
            }
            else if(flag_輸送系統_輸送帶入料區有盤 == false)
            {
                if (flag_輸送系統_輸送帶CCD區有盤 == true)
                {
                    Console.WriteLine($"[輸送一格] 入料區無料,CCD區有盤,等待不良排除區盤感應到達");
                    PLC_Device_輸送系統_輸送帶解煞車.Bool = true;
                    PLC_Device_輸送系統_輸送帶正轉.Bool = true;
                    cnt = 200;
                    return;
                ...
                else if (flag_輸送系統_輸送帶CCD區有盤 == false)
                {
                    ...
                    {
                        Console.WriteLine($"[輸送一格] 入料區無料,CCD區無料,不良排除區有盤,等待出料區盤感應到達");
                        PLC_Device_輸送系統_輸送帶解煞車.Bool = true;
                        PLC_Device_輸送系統_輸送帶正轉.Bool = true;
                        cnt = 300;
                        return;
                    ...
                    {
                        Console.WriteLine($"[輸送一格] 入料區無料,CCD區無料,不良排除區無料,等待出料區盤感應到達");
                        PLC_Device_輸送系統_輸送帶解煞車.Bool = true;
                        PLC_Device_輸送系統_輸送帶正轉.Bool = true;
                        cnt = 300;
                        return;
        ...
        void cnt_Program_輸送系統_輸送一格_300_等待出料區盤感應離開(ref int cnt)
        {
            if (flag_輸送系統_輸送帶出料區無盤 || true)
            {
                cnt++;
            }
        }
        void cnt_Program_輸送系統_輸送一格_300_等待出料區盤感應到達(ref int cnt)
        {
            if (flag_輸送系統_輸送帶出料區有盤)
            {
                cnt++;
            }
        }
